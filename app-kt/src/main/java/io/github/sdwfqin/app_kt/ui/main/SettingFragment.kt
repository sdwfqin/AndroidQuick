...
import io.github.sdwfqin.app_kt.databinding.FragmentSettingBinding
...
class SettingFragment : BaseFragment<FragmentSettingBinding>() {
    ...
    override fun getViewBinding(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): FragmentSettingBinding {
    ...
    override fun initClickListener() {
        mBinding.llChangeSkin.setOnClickListener { v: View? -> changeSkin() }
    }
