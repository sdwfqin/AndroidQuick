...
public class CreateCodeTools {
    ...
    public static class Builder {
        ...
        public Bitmap builder(@Nullable ImageView imageView) {
            Bitmap bitmap = CreateCodeTools.createQRCode(content, width, backgroundColor, codeColor, margin);
            if (imageView != null) {
    ...
    public static Bitmap createQRCode(CharSequence content, int QR_WIDTH, int backgroundColor, int codeColor, int margin) {
        Bitmap bitmap = null;
        try {
            // 判断URL合法性
    ...
    public static Bitmap createQRCode(CharSequence content, int QR_WIDTH, int margin) {
        return createQRCode(content, QR_WIDTH, 0xffffffff, 0xff000000, margin);
    }

    public static Bitmap createQRCode(CharSequence content, int QR_WIDTH) {
        return createQRCode(content, 800, 16);
    }

    public static Bitmap createQRCode(CharSequence content) {
        return createQRCode(content, 16);
    }
